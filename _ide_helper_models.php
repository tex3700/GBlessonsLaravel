...
/**
 * App\Models\News\Category
 *
 * @property int $id
 * @property string $title Название категории
 * @property string $slug slug категории
 ...
 * @property string $title Загаловок новости
 * @property string $text Текст новости
 * @property int $isPrivate Доступно ли содержание новости для неавтризованного пользователя
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
